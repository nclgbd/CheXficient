...
def init_distributed_mode(args):
    if args.dist_on_itp:
        ...
        print("     how many GPUs &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&", args.rank, args.world_size, args.gpu)
...
def save_model(args, epoch, epoch_name, model, model_without_ddp, optimizer, global_example_ids, loss_scaler, best_val_loss=None, best_acc=None, step=None):
    ...
    if loss_scaler is not None:
        ...
        for checkpoint_path in checkpoint_paths:
            to_save = {
                ...
                'best_acc': best_acc,
                'step': step,
                'subset': global_example_ids,
            }
            save_on_master(to_save, checkpoint_path)
    else:
        client_state = {'epoch': epoch, 'best_val_loss': best_val_loss, 'best_acc': best_acc, 'step': step, 'subset': global_example_ids}
